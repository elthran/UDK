  ...
  <div v-if="!loading">
    <div class="content flex-container">
      <div
        ...
        style="margin: 5px; min-width: 600; order: 0;
      ...
      >
        ...
        <br />
        <p>
          You currently have the following resources:<br />{{ county.wood }} Wood,
          {{ county.stone }} Stone, {{ county.iron }} Iron, and {{ county.gold }} Gold.
        </p>
      </div>
      <div
      ...
      >
        <p>
          {{ county.title }} {{ county.leader }} rules this land wisely, perhaps because his
          {{ county.background }}ly education. Within his {{ county.land }} acres he has
          {{ county.population }} loyal subjects.
        </p>
      </div>
