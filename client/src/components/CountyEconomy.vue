      ...
      >
        <table class="odd">
          ...
          <tr>
            ...
            <td>
              Your basic birth rate is based on your total land. Happiness, tax rate, and
              health will affect population growth.
            </td>
          </tr>
          <tr>
            <td>Gold</td>
            ...
            <td>
              <ul>
                <li v-if="county.productionChoice === 'Overwork'">
            ...
            <td v-if="county.taxRate < 7" class="green">
              Your current tax rate has a positive effect on happiness.
            </td>
            <td v-else-if="county.taxRate === 7">
          ...
          <tr>
            ...
            <td>
              Excess dairy can not be stored in your granaries. If you do not have enough
              food, your populace will begin to starve.
            </td>
          </tr>
          <tr>
            <td>Lumber</td>
          ...
          <tr>
            ...
            <td>-</td>
            <td>
              Mana is used to cast spells as well as dispel enemy magic. You can raise your
              maximum mana by researching arcane lore.
            </td>
          </tr>
          <tr>
            <td>Happiness</td>
            ...
            <td></td>
            <td>
              Happiness affects your birth rate. If they become too unhappy, they may start
          ...
          <tr>
            ...
            <td>-</td>
            <td>
              Healthiness affects your death rate. As they become more unhealthy, they die
              and get sick much more easily. Your healthiness decreases by 1% for every 200
              unfed people each day.
            </td>
          </tr>
        </table>
      </div>
